...
import { MappingCollection, Collection } from "../../src/collections/collection";
...
describe('MapCollection', function () {  
    it('should map empty array', () => {
        ...
        const collection = new MappingCollection<Cat, number>(new Collection(items), cat => cat.age ** 2);
